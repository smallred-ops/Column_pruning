...
from Generate_patterns.random_generate_column_whole_pattern import random_generate_column_whole_pattern
...
#CUDA_VISIBLE_DEVICES=3 nohup python -u only_random_column_pruning.py --epochs 10 --random > only_random_column_pruning_average